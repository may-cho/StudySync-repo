...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        file_path = os.path.join(settings.BASE_DIR, 'core', 'fixtures', 'majors.json')
        ...
        with open(file_path, 'r') as f:
            try:
                ...
                self.stderr.write(self.style.ERROR("Invalid JSON format in major.json"))
                return

        self.stdout.write(self.style.WARNING(f"Starting import of {len(data)} majors..."))
